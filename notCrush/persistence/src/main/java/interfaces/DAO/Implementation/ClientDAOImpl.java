package interfaces.DAO.Implementation;

import interfaces.DAO.GenericDAOImpl;
...
//    }
    ...
    public List<ClientPO> getAll(Class xx) {
        TypedQuery<ClientPO> query = entityManager.createQuery("from " + xx.getName(), xx);
